...
*                   (f) PendSV.
*
*               (3) The maximum Cortex-M23 table position is 256 and for the Cortex-M33 table position 
*                   is 480. A particular Cortex-M may have fewer than 464 external exceptions and, 
*                   consequently, fewer than 480 table positions. This function assumes that the specified 
*                   table position is valid if the interrupt controller type register's INTLINESNUM field
*                   is large enough so that the position COULD be valid.
*********************************************************************************************************
*/
