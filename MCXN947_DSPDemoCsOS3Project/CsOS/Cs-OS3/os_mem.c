...
*
* Description : Create a fixed-sized memory partition that will be managed by Cs/OS3.
*
...
*
* Description : This function is called by Cs/OS3 to initialize the memory partition manager.  Your
